...
const navigation = [
  ...
  { name: 'Agenda', href: '/turnos', icon: Calendar },
  { name: 'Pacientes', href: '/pacientes', icon: Users },
  { name: 'Profesionales', href: '/profesionales', icon: UserCheck },
  { name: 'Aranceles', href: '/aranceles', icon: DollarSign },
  { name: 'Prácticas', href: '/practicas', icon: Activity },
];
